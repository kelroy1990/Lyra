...
// UAC2 Entity IDs (defined in descriptor macro below)
...
// Total descriptor length for stereo speaker with feedback EP
...
#define TUD_AUDIO_SPEAKER_STEREO_FB_DESCRIPTOR(_itfnum, _stridx, _nBytesPerSample, _nBitsUsedPerSample, _epout, _epoutsize, _epfb, _epfbsize) \
  ...
  /* Standard AS Interface Descriptor(4.9.1) - Interface 1, Alternate 0 - zero bandwidth */\
  TUD_AUDIO_DESC_STD_AS_INT(/*_itfnum*/ (uint8_t)((_itfnum) + 1), /*_altset*/ 0x00, /*_nEPs*/ 0x00, /*_stridx*/ 0x00),\
  /* Standard AS Interface Descriptor(4.9.1) - Interface 1, Alternate 1 - data streaming */\
